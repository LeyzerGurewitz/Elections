...
const findUserName = (userName) => __awaiter(void 0, void 0, void 0, function* () {
    const isFindUser = yield Voters_1.default.findOne({ userName });
    if (isFindUser) {
...
const createUser = (user) => __awaiter(void 0, void 0, void 0, function* () {
    const newUser = yield Voters_1.default.create(user);
    if (!newUser) {
...
const findUserInDB = (userName) => __awaiter(void 0, void 0, void 0, function* () {
    const newUser = yield Voters_1.default.findOne({ userName: userName });
    if (!newUser) {
